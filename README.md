...
![Example of Github Projects](docs/img/1.png)

- Find the task that has been assigned to you.

![Example of Github Projects](docs/img/2.png)

- Open the task and select Convert to Issue (if it’s not an issue yet).

![Example of Github Projects](docs/img/3.png)

- Choose the correct repository when creating the issue

![Example of Github Projects](docs/img/4.png)
